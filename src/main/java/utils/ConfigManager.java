...
public class ConfigManager {
    ...
    * 
    * @param key
    *           - ConfigParamvalue that requires to be returned from Config.properties file
    ...
    * 
    * @param sKey
    *           key to write app.properties
    * @param sData
    *           data to write app.properties
    */
   public void writeProperty(String sKey, String sData) throws ConfigurationException {
   ...
   private String getConfigFolderPath() {
      return System.getProperty("user.dir") + fileSeperator + "config";
   }
}
